...
export default function WifiQrCodePage() {
  ...
  return (
    <QrCodePageLayout
      title="Wi-Fi QR 코드 생성기"
      description="Wi-Fi 네트워크 정보를 QR 코드로 변환하여 쉽게 연결을 공유하세요."
      qrType="wifi"
    >
      <QrCodeTypeNavigation />
      <WifiForm onWifiDataChange={handleWifiDataChange} />
    </QrCodePageLayout>
  );
}
